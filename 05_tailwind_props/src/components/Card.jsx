...
// function Card(props) {
  // console.log(`props`, props.beach);

function Card({ beach, btnText="Explore More" }) {


  return(
    <>
    <h1>Reusability Component With Props</h1>
    ...
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      ...
      <div className="flex items-center justify-between">
        <button className="px-4 py-2 bg-white hover:bg-gray-200 text-sm rounded-lg transition-colors duration-200">
          {btnText}
        </button>
...
whenever you create component then you have the access of props.
